...
-   [Safe Harbor for Protocols](./protocol)
-   [Safe Harbor for Whitehats](./whitehat)
...
For more details you can review [Safe Harbor for Protocols](./protocol) and [Safe Harbor for Whitehats](./whitehat).
